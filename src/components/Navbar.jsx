...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:${personalInfo.emails.primary}?subject=Portfolio Inquiry&body=Hello ${personalInfo.firstName},%0D%0A%0D%0AI came across your portfolio and would like to discuss an opportunity with you.%0D%0A%0D%0ALooking forward to hearing from you.%0D%0ABest Regards,`;
  return (
    <nav 

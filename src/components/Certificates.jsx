    ...
    <section className="bg-[#ff2a2a] pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      {/* Header */}
        ...
        <p className="text-red-100 text-base md:text-lg font-semibold max-w-lg mx-auto">
          Professional internships, hackathon participation, and certifications that reflect my continuous learning, technical growth, and hands-on experience.
        </p>
      </div>
        ...
        >
          <path
            ...
            strokeWidth="2"
            d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M12 4v10m0 0l-3-3m3 3l3-3"
          />
        </svg>
